		...
		<div class="row justify-content-between">
			<div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
				<div data-aos="zoom-out">
					<h1>Temukan <span>Personal Trainer</span> dan <span>Tempat Fitness</span> anda sekarang</h1>
					<h2>Masuk sebagai</h2>
			...
			<div class="row" data-aos="fade-up">
				...
				<div class="col-lg-4 col-md-4 col-12">
					<div class="count-box">
						...
						<span data-purecounter-start="0" data-purecounter-end="509" data-purecounter-duration="1" class="purecounter"></span>
						<p>
							Customer
						</p>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-12 mt-5 mt-lg-0">
					<div class="count-box">
						<i class="bi bi-emoji-smile"></i>
	...
	<section id="team" class="team">
		<div class="container">
			...
			<div class="section-title" data-aos="fade-up">
				...
				<p>Daftar Personal Trainer Terbaik Kami</p>
			</div>
